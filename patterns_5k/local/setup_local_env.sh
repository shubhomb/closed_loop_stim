#!/bin/bash
# =====================================================================
# Local workstation env setup for patterns_5k sweeps.
#
...
#   /home/user/users/<owner>/envs/patterns5k_local_venv
#
# Usage:
#   bash local/setup_local_env.sh
#
# After it finishes:
#   source /home/user/users/<owner>/envs/patterns5k_local_venv/bin/activate
...
OWNER="${OWNER:-shubhom}"
ENV_DIR="${ENV_DIR:-/home/user/users/${OWNER}/envs/patterns5k_local_venv}"
...
echo "========================================"
echo "  Patterns5k local venv setup"
echo "  Host:    $(hostname)"
