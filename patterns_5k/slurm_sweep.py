...
def main():
    ...
    parser.add_argument("--slurm-template", type=str, default="nots_gpu.slurm",
    ...
    sweep_dir = args.output_dir or os.path.join("results", f"{sweep_name}_{timestamp}")
