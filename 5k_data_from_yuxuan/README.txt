Data from Animal ICMS 148, with 3 shanks out of 4 successfully implanted. Each shank has 32 linearly arranged channels. Currents used for all stimulation pulses are 3uA. Duration of pulse is a 167-66-167us biphasic structure (with 66us as inter-phase-interval). The sampling rate is namely 30K Hz, but there're fluctuations. So it's recommended to just use the timestamps already accurately registered in the data files instead of directly converting to physical times as a start point.
